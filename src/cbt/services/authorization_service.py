...
class AuthorizationService:
    ...
    async def check_role_permission(self, role: str, permission: str) -> bool:
        ...
        role_permissions = {
            ...
            "EXAM_OFFICER": {
                "user.read", "student.read", "student.import", "academic.read", "course.read",
                "venue.read", "venue.update",
                "exam.read", "exam.create", "exam.update", "exam.schedule", "exam.publish",
                "exam.cancel", "exam.manage",
            ...
            "ADMINISTRATOR": {
                ...
                "exam.read", "exam.create", "exam.update", "exam.delete", "exam.schedule",
                "exam.publish", "exam.cancel", "exam.manage", "exam.invigilate",
